...
// console.log(Person.prototype.sayMyName())
...
var newFunction = Person.prototype.ageAYear.bind(ajax)
// console.log(ajax.age)

var ajaxAger = function() {
  newFunction()
}


// console.log(ajaxAger())
